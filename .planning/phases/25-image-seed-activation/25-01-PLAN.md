...
> **Note (2026-09-02):** sharp was removed from the project in `bb3c4b0` — it was
> only ever used for this one-off resize and was never imported by committed code.
> Don't reinstall it from these steps; use any local image tool, or add it
> temporarily and uninstall afterwards.
